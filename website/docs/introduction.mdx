...
It is written with ❤️ in [Rust](https://www.rust-lang.org) and is [**absolutely free**](https://github.com/rnza0u/blaze/blob/master/LICENCE) to use.

Its main goal is to allow you to run multiple tasks across your monorepo in an efficient way.
